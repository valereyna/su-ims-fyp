...
<head>
    ...
    <link rel="shortcut icon" href="{{ URL::to('assets/img/su-spark-icon.ico') }}">
...
<body>
    <div class="main-wrapper">
        <div class="header">
            <div class="header-left">
                <a href="{{ route('home') }}" class="logo">
                    <img src="{{ URL::to('assets/img/logo-su.png') }}" alt="Logo" height="40" width="80">
                </a>
                <a href="{{ route('home') }}" class="logo logo-small">
                    <img src="{{ URL::to('assets/img/logo-su-small.png') }}" alt="Logo" width="30" height="30">
                </a>
            </div>
        ...
        @yield('content')
        <footer>
            <p>Internship Management System <?php echo date('Y'); ?></p>
        </footer>
