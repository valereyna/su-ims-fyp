...
class UserManagementController extends Controller
{
    ...
    public function updateAvatar(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Profile Picture updates successfully.');
    }
    ...
    public function updateProfile(Request $request)
    {
        ...
        $user = auth()->user();
        $user->update($request->only('name', 'date_of_birth', 'email', 'phone_number'));

        // Update session data if used
        session([
            'name' => $user->name,
    ...
    {
        return User::where('role_name', 'student')->count();
    }
    ...
    public function getUserCountsByRole()
    {
        return [
            ...
            'advisors' => User::where('role_name', 'advisor')->count(),
            'coordinators' => User::where('role_name', 'coordinator')->count(),
